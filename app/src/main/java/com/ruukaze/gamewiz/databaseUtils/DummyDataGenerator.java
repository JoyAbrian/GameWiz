...
public class DummyDataGenerator {
    ...
    public static ArrayList<Post> generateDummyPost() {
        ...
        posts.add(new Post(1, 1, 1, "Welcome to QuestKeepers! We're excited to have you join our community of gamers dedicated to completing quests and challenges. Feel free to introduce yourself and share your latest gaming achievements!", "https://source.unsplash.com/1600x900/?gaming,quest"));
        posts.add(new Post(2, 1, 11, "Hey everyone! I'm new here and I'm looking forward to connecting with fellow gamers. I recently completed a challenging quest in my favorite game and I'm feeling pretty proud of myself!", "https://source.unsplash.com/1600x900/?gamer,quest"));
        posts.add(new Post(3, 1, 31, "Greetings, QuestKeepers! I'm excited to be part of this community. I'm currently working on a difficult quest and could use some tips and advice. Any suggestions?", "https://source.unsplash.com/1600x900/?gaming,advice"));
        posts.add(new Post(4, 1, 41, "Hello, fellow QuestKeepers! I'm thrilled to be here. I just completed a quest that took me hours to finish, but the sense of accomplishment was worth it. What's your most memorable quest completion?", "https://source.unsplash.com/1600x900/?gaming,accomplishment"));
        posts.add(new Post(5, 1, 141, "Welcome to all the new members of QuestKeepers! We're glad to have you here. Let's share our gaming experiences and support each other in our questing adventures!", "https://source.unsplash.com/1600x900/?gaming,community"));
        posts.add(new Post(6, 1, 131, "Hey everyone! I'm excited to join this community. I'm currently stuck on a quest in my favorite game and could use some help. Any tips or strategies you can share?", "https://source.unsplash.com/1600x900/?gaming,help"));
        posts.add(new Post(7, 1, 91, "Greetings, QuestKeepers! I'm new here and I'm looking forward to connecting with fellow gamers. I recently completed a challenging quest and I'm feeling pretty proud of myself!", "https://source.unsplash.com/1600x900/?gamer,challenge"));
        posts.add(new Post(8, 1, 101, "Hello, fellow QuestKeepers! I'm thrilled to be here. I just completed a quest that took me hours to finish, but the sense of accomplishment was worth it. What's your most memorable quest completion?", "https://source.unsplash.com/1600x900/?gaming,success"));
        posts.add(new Post(9, 1, 111, "Welcome to all the new members of QuestKeepers! We're glad to have you here. Let's share our gaming experiences and support each other in our questing adventures!", "https://source.unsplash.com/1600x900/?gaming,friends"));
        posts.add(new Post(10, 2, 2, "Welcome to ArcadeLegends! This is the perfect place for fans of classic arcade games to share their love for the classics. Feel free to discuss your favorite games and memories!", "https://source.unsplash.com/1600x900/?arcade,retro"));
        posts.add(new Post(11, 2, 12, "Hey everyone! I'm new here and I'm excited to connect with fellow arcade game enthusiasts. I recently rediscovered my favorite childhood game and it brought back so many memories. What's your favorite classic arcade game?", "https://source.unsplash.com/1600x900/?arcade,childhood"));
        posts.add(new Post(12, 3, 33, "Greetings, ArcadeLegends! I'm thrilled to be part of this community. I recently completed a challenging level in my favorite arcade game and I'm feeling pretty accomplished. What's your latest gaming achievement?", "https://source.unsplash.com/1600x900/?arcade,achievement"));
        posts.add(new Post(13, 3, 43, "Hello, fellow ArcadeLegends! I'm excited to join this community. I'm currently working on mastering a difficult level in my favorite arcade game and could use some tips and strategies. Any advice?", "https://source.unsplash.com/1600x900/?arcade,tips"));
        posts.add(new Post(14, 3, 103, "Welcome to all the new members of ArcadeLegends! We're glad to have you here. Let's share our love for classic arcade games and reminisce about the good old days of gaming!", "https://source.unsplash.com/1600x900/?arcade,classic"));
        posts.add(new Post(15, 4, 104, "Hey everyone! I'm excited to be part of this community. I recently rediscovered my favorite childhood arcade game and it brought back so many memories. What's your favorite classic arcade game?", "https://source.unsplash.com/1600x900/?arcade,game"));
        posts.add(new Post(16, 4, 114, "Hey ArcadeLegends! Just reached a new high score in Pac-Man! Feeling like a true arcade champion. Who else loves this classic game?", "https://source.unsplash.com/1600x900/?arcade,pacman"));
        posts.add(new Post(17, 4, 104, "Greetings, fellow gamers! I'm on a quest to beat the high score in Galaga. Any tips on how to dodge those pesky enemy ships?", "https://source.unsplash.com/1600x900/?arcade,galaga"));
        posts.add(new Post(18, 4, 94, "Welcome to ArcadeLegends! Let's challenge each other to beat our favorite arcade game high scores. Who's up for some friendly competition?", "https://source.unsplash.com/1600x900/?arcade,competition"));
        posts.add(new Post(19, 4, 64, "Hey everyone! I'm new to this community. Can't wait to share my love for classic arcade games with all of you. What's your go-to game when you visit the arcade?", "https://source.unsplash.com/1600x900/?arcade,favorite"));
        posts.add(new Post(20, 5, 145, "Greetings RetroGamers! Just completed the final boss in Super Mario Bros. What a nostalgic journey! Share your favorite Mario memories with me.", "https://source.unsplash.com/1600x900/?mario,retro"));
        posts.add(new Post(21, 5, 25, "Hey fellow gamers! Who remembers spending hours playing Tetris on their old Game Boy? Let's relive those block-stacking memories together!", "https://source.unsplash.com/1600x900/?tetris,gameboy"));
        posts.add(new Post(22, 5, 15, "Welcome to RetroGamers! Whether you're a fan of NES, SNES, or Sega Genesis, this is the place to reminisce about the golden age of gaming. What's your favorite retro console?", "https://source.unsplash.com/1600x900/?retro,console"));
        posts.add(new Post(23, 5, 5, "Hey everyone! Just dusted off my old Atari 2600 and rediscovered the joy of classic gaming. What's your favorite Atari game?", "https://source.unsplash.com/1600x900/?atari,classic"));
        posts.add(new Post(24, 6, 106, "Greetings RPG Enthusiasts! Just finished a marathon session of Final Fantasy VII. The storyline still blows my mind every time. What's your favorite RPG of all time?", "https://source.unsplash.com/1600x900/?rpg,finalfantasy"));
        posts.add(new Post(25, 6, 16, "Hey gamers! Who else spent countless hours exploring the vast world of Skyrim? Share your epic adventures and memorable moments in Tamriel!", "https://source.unsplash.com/1600x900/?skyrim,adventure"));
        posts.add(new Post(26, 6, 46, "Welcome to RPG Haven! Whether you're a fan of turn-based classics or open-world epics, this community is your sanctuary for all things RPG. What's your favorite character build?", "https://source.unsplash.com/1600x900/?rpg,character"));
        posts.add(new Post(27, 6, 16, "Hey everyone! Just discovered a hidden gem in the indie RPG scene. Can't wait to dive deeper into the captivating storyline. Any indie RPG recommendations?", "https://source.unsplash.com/1600x900/?rpg,indie"));
        posts.add(new Post(28, 7, 7, "Greetings Strategy Masters! Just pulled off a flawless victory in Civilization VI. Who else loves the thrill of building and conquering civilizations?", "https://source.unsplash.com/1600x900/?strategy,civilization"));
        posts.add(new Post(29, 7, 17, "Hey fellow strategists! What's your favorite real-time strategy game? Let's discuss tactics, build orders, and epic battles!", "https://source.unsplash.com/1600x900/?strategy,rts"));
        posts.add(new Post(30, 7, 67, "Welcome to Strategy Central! Whether you're into grand strategy epics or fast-paced tactics, this community is your headquarters for all things strategy. What's your go-to strategy for dominating the battlefield?", "https://source.unsplash.com/1600x900/?strategy,battlefield"));
        posts.add(new Post(31, 7, 37, "Hey everyone! Just discovered a new indie strategy game with a unique twist. Can't wait to test out different strategies and see how they play out!", "https://source.unsplash.com/1600x900/?strategy,indie"));
        posts.add(new Post(32, 8, 38, "Greetings MOBA Enthusiasts! Just scored a pentakill in League of Legends. Who else loves the adrenaline rush of teamfights and epic plays?", "https://source.unsplash.com/1600x900/?moba,leagueoflegends"));
        posts.add(new Post(33, 8, 8, "Hey summoners! What's your main role in MOBAs? Whether you're a top lane bruiser or a support main, let's talk about our favorite champions and strategies!", "https://source.unsplash.com/1600x900/?moba,champions"));
        posts.add(new Post(34, 8, 18, "Welcome to MOBA Madness! Whether you're a veteran of the lanes or a newcomer to the genre, this community is your battleground for all things MOBA. Who's ready to climb the ranked ladder?", "https://source.unsplash.com/1600x900/?moba,ranked"));
        posts.add(new Post(35, 8, 88, "Hey everyone! Just had an intense match in Dota 2 that went down to the wire. What's your most memorable comeback victory in a MOBA?", "https://source.unsplash.com/1600x900/?moba,dota2"));
        posts.add(new Post(36, 9, 39, "Greetings Fighting Game Fans! Just pulled off a flawless combo in Street Fighter V. Who else loves the thrill of one-on-one battles and epic matchups?", "https://source.unsplash.com/1600x900/?fighting,streetfighter"));
        posts.add(new Post(37, 9, 39, "Hey fighters! What's your main character in fighting games? Whether you prefer speed and agility or brute strength, let's discuss our favorite fighters and matchups!", "https://source.unsplash.com/1600x900/?fighting,characters"));
        posts.add(new Post(38, 9, 99, "Welcome to the Fighting Game Arena! Whether you're a seasoned veteran or a newcomer to the genre, this community is your ring for all things fighting games. Who's up for a challenge?", "https://source.unsplash.com/1600x900/?fighting,arena"));
        posts.add(new Post(39, 9, 9, "Hey everyone! Just discovered a new indie fighting game with a unique art style. Can't wait to master the combos and take on challengers!", "https://source.unsplash.com/1600x900/?fighting,indie"));
        posts.add(new Post(40, 10, 100, "Greetings Sports Fans! Just scored a game-winning goal in FIFA 21. Who else loves the thrill of competitive sports games and epic moments on the field?", "https://source.unsplash.com/1600x900/?sports,fifa"));
        posts.add(new Post(41, 10, 110, "Hey athletes! What's your favorite sports game franchise? Whether you're a fan of basketball, soccer, or racing, let's talk about our favorite teams and players!", "https://source.unsplash.com/1600x900/?sports,franchise"));
        posts.add(new Post(42, 10, 60, "Welcome to the Sports Arena! Whether you're a casual fan or a hardcore competitor, this community is your stadium for all things sports games. Who's ready to hit the virtual field?", "https://source.unsplash.com/1600x900/?sports,arena"));
        posts.add(new Post(43, 10, 30, "Hey everyone! Just had an intense match in NBA 2K21 that went into overtime. What's your most memorable sports game comeback victory?", "https://source.unsplash.com/1600x900/?sports,nba"));
